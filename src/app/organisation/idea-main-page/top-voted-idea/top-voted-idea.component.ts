...
@Component({
  selector: 'app-top-voted-idea',
  templateUrl: './top-voted-idea.component.html',
  styleUrls: ['./top-voted-idea.component.css'],
})
export class TopVotedIdeaComponent implements OnInit {
  Organisation: any;
  ...
  refreshIdeaList(){
    ...
    this._ideaService.getTopVotedIdeas(this.organisationDomain).subscribe(
      (res) => {
       
        this.allIdeas = res;
        this.allIdeas = this.allIdeas.topVotedIdeas;
      },
      (err) => {
