...
@Component({
  selector: 'app-single-just-approved-idea',
  templateUrl: './single-just-approved-idea.component.html',
  styleUrls: ['./single-just-approved-idea.component.css']
})
export class SingleJustApprovedIdeaComponent implements OnInit,AfterViewInit {
